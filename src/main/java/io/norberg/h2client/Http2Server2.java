...
public class Http2Server2 {

  private static final Logger log = LoggerFactory.getLogger(Http2Server2.class);
  ...
  private final ServerConnection2.Builder connectionBuilder;

  private Http2Server2(final Builder builder) {
    this.group = Util.defaultEventLoopGroup();
    this.connectionBuilder = ServerConnection2.builder()
  ...
  public static Http2Server2 create(final RequestHandler requestHandler) {
    return builder()
  ...
  public static class Builder {
    ...
    public Http2Server2 build() {
      return new Http2Server2(this);
    }
  }
