...
final class HpackDynamicTableIndex4 {
  ...
  HpackDynamicTableIndex4(final HpackDynamicTable headerTable) {
  ...
  static int hash(AsciiString name, AsciiString value) {
  ...
  public int index(final AsciiString value, final AsciiString method) {
    return lookup(value, method);
  }
  ...
  public void remove(final Http2Header header, final int index) {
    remove(header);
  }

  public void add(final Http2Header header) {
    insert(header);
  }

  public int index(final AsciiString name) {
    return lookup(name);
  }
}