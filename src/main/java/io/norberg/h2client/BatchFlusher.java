...
class BatchFlusher {
  ...
  BatchFlusher(final Channel channel, final EventLoop eventLoop) {
    this(channel, eventLoop, DEFAULT_MAX_PENDING);
  }

  BatchFlusher(final Channel channel, final EventLoop eventLoop, final int maxPending) {
