...
import io.norberg.h2client.Http2Client2;
...
class BenchmarkClient2 {
  ...
  static void run() throws Exception {
    ...
    final Http2Client2.Listener listener = new Http2Client2.ListenerAdapter() {
      @Override
    ...
    final Http2Client2 client = Http2Client2.builder()
        .listener(listener)
  ...
  private static void get(final Http2Client2 client, final ProgressMeter.Metric requests,
